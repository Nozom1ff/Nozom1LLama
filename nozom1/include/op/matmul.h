...
#ifndef __NOZOM1_INCLUDE_OP_MATMUL_H__
#define __NOZOM1_INCLUDE_OP_MATMUL_H__
...
public:
    explicit MatmulLayer(base::DeviceType device_type,
                         ...
                         bool has_bias       = false,
                         base::DataType      = base::DataType::kTypeFp32);

    base::Status check() const override;

    base::Status forward() override;
    // NOTE 注意，这个函数内部直接用了layer的datatype赋给tensor
