...
MultiHeadAttention::MultiHeadAttention(base::DeviceType device_type,
    ...
    : Layer(device_type, LayerType::kLayerMHA, data_type, "MultiHead"),
...
base::Status MultiHeadAttention::forward()
{
    ...
    kernel::get_mha_kernel(device_type_)(pos_,
                                         head_num_,
                                         layer_index_,
                                         seq_len_,
                                         kv_dim_,
...
void MultiHeadAttention::set_layer_idx(int32_t layer_idx)
{
